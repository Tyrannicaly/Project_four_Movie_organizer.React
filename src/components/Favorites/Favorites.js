    ...
    render() {
        return (
            <div className="favorites">
                <input onChange={this.changeInptValue} value={this.state.title} placeholder="Новый список"
                ...
                {!this.state.showBtn &&
                <Link onClick={() => this.props.getKey(this.state.idFromServer)} to={`/list/${this.state.title}`}>Перейти
                    к списку</Link>}
            </div>
        );
    }
